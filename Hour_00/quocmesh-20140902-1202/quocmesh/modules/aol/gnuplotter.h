...
class Plotter {
protected:
  char _noutput[1024], _plotfile[1024], _title[1024], _special[1024], _xlabel[1024], _ylabel[1024], _plotcommand[1024], _outputDir[1024], _terminal[1024];
...
public:
  ...
  void addPlotCommand( const char *DataFileName, const PlotStyle Style, const int LineStyleNumber = -2 ){
    ...
    case GNUPLOT_VECTOR:
      {
        additionalPlotCommand += "\" w vec notitle";
      }
      break;
    case GNUPLOT_BOXES:
      {
        additionalPlotCommand += "\" w boxes notitle";
      }
      break;
    default:
      {
