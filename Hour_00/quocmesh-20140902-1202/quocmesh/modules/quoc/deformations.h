...
inline bool transformCoord ( const typename ConfiguratorType::InitType &Grid,
  ...
  return qc::transformCoord<ConfiguratorType> ( Grid, El, RefCoord, offset, TransformedEl, TransformedLocalCoord );
}
...
class FENonlinDeformOpInterface :
  public aol::FENonlinOpInterfaceWithMovedTestFunctions<ConfiguratorType, FENonlinDeformOpInterface<ConfiguratorType, Imp> > {
...
public:
  explicit FENonlinDeformOpInterface( const typename ConfiguratorType::InitType &Grid, const aol::MultiVector<RealType> &Displacement ) :
    aol::FENonlinOpInterfaceWithMovedTestFunctions<ConfiguratorType, FENonlinDeformOpInterface<ConfiguratorType, Imp> >( Grid ),
...
public:
  explicit DeformMassOp ( const typename ConfiguratorType::InitType &Grid, const aol::MultiVector<RealType> &Displacement, aol::OperatorType OpType = aol::ONTHEFLY, FELinOpBaseFunDeformModeType DeformationMode = BOTH ) :
    FELinDeformScalarWeightedMassInterface<ConfiguratorType, DeformMassOp<ConfiguratorType> > ( Grid, Displacement, OpType, DeformationMode ) {}
